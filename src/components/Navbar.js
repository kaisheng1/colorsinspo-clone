...
const Navbar = () => {
	...
	return (
		<div>
			<svg
				onClick={toogleOpen}
				className="w-6 h-6 cursor-pointer fill-current text-gray-600 hover:text-primary"
			...
			<div
				className={`${isOpen
					? 'block lg:left-0'
					: 'hidden lg:block lg:left-showIcons'} absolute top-32 right-0 w-64 bg-navbar`}
			>
				<div className="h-screen85 overflow-y-auto">
					<div className="flex justify-between bg-blue-100">
						<div className="px-8 py-4 border-l-8 border-primary">
							<span className="-ml-2 font-semibold text-primary">Color Palettes</span>
						</div>
						<div className={`px-8 py-4 ${!isOpen && 'lg:pl-4 lg:border-l-8 lg:border-primary'}`}>
							<svg
